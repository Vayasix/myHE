...
int main(int argc, char** argv)
{
	...
	s.makeLUTable();
	std::cerr << "FOOOOOOOOOOOOOOOOOOOOOO" << std::endl; 	
	std::cerr<<"end of readingg pbwt\n";
	std::cerr<<"set param\n";
	std::string pkeyn="pubkey";
	std::string prvyn="prvkey";
	std::string contyn="context";
	c.setParam(s.v_length, s.B0, s.L0, s.L1, pkeyn, prvyn, contyn);  // keygen
	s.setParam(pkeyn,contyn); //keyset
