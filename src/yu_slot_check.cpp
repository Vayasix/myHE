...
Params::Params(long m, long p, long r, long L, long c, long w, long d, long s, long K, string file)
{
...
//	string file = "slot_time";
	...
	TestIt(m,p,r,L,c,w,d,296,K,file,mmax);
	TestIt(m,p,r,L,c,w,d,424,K,file,mmax);
	TestIt(m,p,r,L,c,w,d,592,K,file,mmax);
	TestIt(m,p,r,L,c,w,d,936,K,file,mmax);
